<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\lunbo\edite.html";i:1584887165;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        <!-- META SECTION -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo url('Lunbo/edite'); ?>" method="post" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <input type="hidden" name="id" value="<?php echo $arr['id']; ?>">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>编辑轮播图</strong></h3>
                                </div>

                                <div class="panel-body">                                                                        
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">上传轮播图</label>
                                        <div class="col-md-6 col-xs-12">
                                                <input type="file" class="form-control" name="image"/>
                                                <img src="/uploads/<?php echo $arr['thumb_pic']; ?>" alt="">
                                        </div>
                                    </div>
