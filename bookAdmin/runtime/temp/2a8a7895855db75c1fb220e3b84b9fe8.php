<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/index\view\book\index.html";i:1584895871;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>Home</title>
		...
		<div class="container">
			...
			<div class="header-left">		
					<ul>
						...
						<li><a  href="<?php echo url('Register/index'); ?>"  >Register</a></li>
      ...
      $("#slider").responsiveSlides({
		...
		<div  id="top" class="callbacks_container">
			<ul class="rslides" id="slider">
				<?php foreach($lunbo as $item3): ?>
			    <li>
					<img src="/uploads/<?php echo $item3['pic']; ?>" alt="">
				</li>
				<?php endforeach; ?>
			</ul>
		</div>
	...
	<div class="container">
		...
		<div class="grid-in">
			...
			<div class="col-md-4 grid-top">
				<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="/uploads/<?php echo $item['image']; ?>" alt="">
							<div class="b-wrapper">
			...
			<p><a href="single.html"><?php echo $item['title']; ?></a></p>
			</div>
			<?php endforeach; ?>
		...
		<div class="grid-in">
			<?php foreach($books2 as $item2): ?>
			<div class="col-md-4 grid-top">
				<a href="single.html" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="/uploads/<?php echo $item2['image']; ?>" alt="">
					<div class="b-wrapper">
									<h3 class="b-animate b-from-left    b-delay03 ">
			...
			<p><a href="single.html"><?php echo $item2['title']; ?></a></p>
			</div>
			<?php endforeach; ?>
