<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\rbac\edite_role.html";i:1584669114;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        <!-- META SECTION -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo url('Rbac/editeRole'); ?>" method="post">
                                <!--隐藏域-->
                                <input type="hidden" name="id" value="<?php echo $arr['id']; ?>">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>更新角色信息</strong></h3>
                                </div>

                                <div class="panel-body">                                                                        
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">英文名</label>
                                    ...
                                    <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">中文名</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
