<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/index\view\login\index.html";i:1584925317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>Login</title>
...
<div class="container">
		...
		<div class="col-md-4 left-account ">
			<a href="single.html"><img class="img-responsive " src="/static/index/images/3.jpg" alt=""></a>
			<a href="<?php echo url('Register/index'); ?>" class="create">Create an account</a>
			<div class="clearfix"> </div>
		</div>
			<!--右侧图片结尾-->
	...
	$("#btn").click(function(){
        ...
        $.ajax({
            ...
            success:function(res){
                if(res.status==1){
                    window.location.href="<?php echo url('Book/index'); ?>";
                }else{
                    layer.msg(res.msg,{
                        title:'错误提示信息',
                        icon:5
