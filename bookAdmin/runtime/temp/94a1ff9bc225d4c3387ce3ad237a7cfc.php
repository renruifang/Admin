<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\rbac\add_rule.html";i:1584694204;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        <!-- META SECTION -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo url('Rbac/addRule'); ?>" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>添加规则</strong></h3>
                                </div>

                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">父规则</label>
                                        <div class="col-md-6 col-xs-12">
                                            <select class="form-control select" name="pid">
                                                <option value="0">--无--</option>
                                                <?php foreach($arr as $item): ?>
                                                <option value="<?php echo $item['id']; ?>" <?php if($item['id']==$id): ?>selected<?php endif; ?>><?php echo $item['title']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
