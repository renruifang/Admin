<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\rbac\edite_administrator.html";i:1584665309;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        <!-- META SECTION -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo url('Rbac/editeAdministrator'); ?>" method="post">
                                <!--隐藏域-->
                                <input type="hidden" name="id" value="<?php echo $arr['id']; ?>">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>更新管理员信息</strong></h3>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="username" value="<?php echo $arr['username']; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="password" value="<?php echo $arr['password']; ?>"/>
                                            </div>            
