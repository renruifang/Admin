<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\index\index.html";i:1584939427;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        <!-- META SECTION -->
...
<!--头部导航结尾-->
        ...
        <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="<?php echo url('login/index'); ?>" class="btn btn-success btn-lg">Yes</a>
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="/static/admin/js/plugins/scrolltotop/scrolltopcontrol.js"></script>
        
        <script type="text/javascript" src="/static/admin/js/plugins/morris/raphael-min.js"></script>
        <script type="text/javascript" src="/static/admin/js/plugins/morris/morris.min.js"></script>
        <script type="text/javascript" src="/static/admin/js/plugins/rickshaw/d3.v3.js"></script>
        <script type="text/javascript" src="/static/admin/js/plugins/rickshaw/rickshaw.min.js"></script>
        <script type='text/javascript' src='/static/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'></script>
        <script type='text/javascript' src='/static/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'></script>
        <script type='text/javascript' src='/static/admin/js/plugins/bootstrap/bootstrap-datepicker.js'></script>
        <script type="text/javascript" src="/static/admin/js/plugins/owl/owl.carousel.min.js"></script>
        
        <script type="text/javascript" src="/static/admin/js/plugins/moment.min.js"></script>
        <script type="text/javascript" src="/static/admin/js/plugins/daterangepicker/daterangepicker.js"></script>
        ...
        <script type="text/javascript" src="/static/admin/js/demo_dashboard.js"></script>
        <!-- END TEMPLATE -->
    <!-- END SCRIPTS -->         
    </body>
</html>
