<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\book\edite.html";i:1584874641;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>        
        <!-- META SECTION -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo url('Book/edite'); ?>"  enctype="multipart/form-data" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>添加书籍</strong></h3>
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">书籍名称</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <img src="/uploads/<?php echo $arr['image_thumb']; ?>" alt="">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">书籍总数</label>
                                        <div class="col-md-6 col-xs-12">
                                                <input type="text" class="form-control" name="sum" value="<?php echo $arr['sum']; ?>"/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">借出书籍</label>
                                        <div class="col-md-6 col-xs-12">
                                                <input type="text" class="form-control" name="lend" value="<?php echo $arr['lend']; ?>"/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">现存书籍</label>
                                        <div class="col-md-6 col-xs-12">
                                                <input type="text" class="form-control" name="now" value="<?php echo $arr['now']; ?>"/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">书籍类型</label>
                                        <div class="col-md-6 col-xs-12">
                                            <select class="form-control select" name="category_id">
                                                <?php foreach($categorys as $item): ?>
                                                <option value="<?php echo $item['id']; ?>" <?php if($item['id']==$arr['category_id']): ?>selected<?php endif; ?>><?php echo $item['meta_title']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
