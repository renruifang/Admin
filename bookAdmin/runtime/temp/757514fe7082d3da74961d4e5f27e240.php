<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\PHPTutorial\WWW\tp51\public/../application/admin\view\category\index.html";i:1584689722;s:72:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\left.html";i:1584884924;s:71:"D:\phpStudy\PHPTutorial\WWW\tp51\application\admin\view\common\top.html";i:1584674805;}*/ ?>
                                ...
                                <table class="table table-bordered table-striped table-actions">
                                    <tr>
                                        <th>
                                            ...
                                            [<a href="<?php echo url('Category/add',['id'=>$item['id']]); ?>">添加<?php echo $item['title']; ?>类型</a>]
                                            [<a href="<?php echo url('Category/edite',['id'=>$item['id']]); ?>">修改</a>]
                                            [<a href="javascript:void(0);" data-id="<?php echo $item['id']; ?>" data-k="parents" class="delOne">删除</a>]
                                        </th>
                                    ...
                                    <tr>
                                        <td>
                                            <strong><?php echo $childItem['title']; ?></strong>
                                            [<a href="<?php echo url('Category/edite',['id'=>$childItem['id']]); ?>">修改</a>]
                                            [<a href="javascript:void(0);" data-id="<?php echo $childItem['id']; ?>" data-k="childrens" class="delOne">删除</a>]
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
