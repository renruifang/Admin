                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-actions">
                                    ...
                                    <tr id="trow_1">
                                        ...
                                        <td><img src="/uploads/<?php echo $item['thumb_pic']; ?>" alt=""></td>
                                        <td class="text-center"><?php echo $item['sort']; ?></td>
                                        <td>
                                            <a href="<?php echo url('Lunbo/edite',['id'=>$item['id']]); ?>"><button class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></button></a>
