<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"D:\phpStudy\PHPTutorial\WWW\tp53\public/../application/admin\view\admin\edite_administrator.html";i:1583937949;s:71:"D:\phpStudy\PHPTutorial\WWW\tp53\application\admin\view\common\top.html";i:1583918304;s:72:"D:\phpStudy\PHPTutorial\WWW\tp53\application\admin\view\common\left.html";i:1583993005;}*/ ?>
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="h6 text-uppercase mb-0">Admin Edite</h3>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo url('editeAdministrator'); ?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" name="password" class="form-control" value="<?php echo $arr['password']; ?>">
                                        </div>
                                    </div>
                                    <div class="line"></div>
