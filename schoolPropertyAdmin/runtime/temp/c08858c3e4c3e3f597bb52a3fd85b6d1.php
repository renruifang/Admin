<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\phpStudy\PHPTutorial\WWW\tp53\public/../application/admin\view\admin\role.html";i:1584002043;s:71:"D:\phpStudy\PHPTutorial\WWW\tp53\application\admin\view\common\top.html";i:1583918304;s:72:"D:\phpStudy\PHPTutorial\WWW\tp53\application\admin\view\common\left.html";i:1583993005;}*/ ?>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">Role</h6>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-hover card-text">
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <a href="<?php echo url('admin/editeRole',['id'=>$value['id']]); ?>" class="fontColor">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="<?php echo url('admin/delRole',['id'=>$value['id']]); ?>" class="fontColor">删除</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    </tbody>
...
<script>
    ...
    $("#delAll").click(function(){
        ...
        $.ajax({
            url:"<?php echo url('admin/delAll2'); ?>",
            type:'post',
            data:{
