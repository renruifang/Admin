<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\PHPTutorial\WWW\tp53\public/../application/admin\view\register\index.html";i:1583917875;}*/ ?>
            ...
            <div class="col-lg-5 px-lg-4">
                ...
                <form id="loginForm" class="mt-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <img src="<?php echo url('register/verify'); ?>" alt="" class="picture" id="pic">
                    </div>
                    <button type="button" class="btn btn-primary shadow px-5" id="btn">注册</button>
                </form>
            </div>
        </div>
...
<script>
    $("#pic").click(function(){
        $(this).attr('src',"<?php echo url('register/verify'); ?>")
    })
</script>
</body>
</html>