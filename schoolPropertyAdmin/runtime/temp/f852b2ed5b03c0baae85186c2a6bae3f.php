<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\tp53\public/../application/admin\view\book\add_book.html";i:1583929234;s:71:"D:\phpStudy\PHPTutorial\WWW\tp53\application\admin\view\common\top.html";i:1583918304;s:72:"D:\phpStudy\PHPTutorial\WWW\tp53\application\admin\view\common\left.html";i:1583993005;}*/ ?>
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="h6 text-uppercase mb-0">Book Add</h3>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo url('addBook'); ?>" method="post">
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label">书籍名称</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label">书籍类型</label>
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label">书籍数量</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="line"></div>
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label">书籍单价</label>
                                        <div class="col-md-9">
